...
import { SearchIcon } from '@/components/molecules/NavbarIcons';
...
export const Navbar: React.FC = () => {
  ...
  const handleLogout = async () => {
    await signOut({
      redirect: true, // Redirect to the homepage after logout
      callbackUrl: '/login', // URL to redirect to after logout
    });
  };
